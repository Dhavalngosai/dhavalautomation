...
echo  Results folder: results\create-DHE-Opp-LifeCycle\
...
call "%NPM_CMD%" test -- tests1/create-DHE-Opp-LifeCycle.spec.ts %HEADED_ARGS% %*
...
if %EXITCODE% equ 0 (
  ...
  echo  See results\create-DHE-Opp-LifeCycle\playwright-report\ for details.
)
echo ============================================
echo.
