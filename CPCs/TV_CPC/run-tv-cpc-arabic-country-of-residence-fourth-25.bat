...
REM Run offset+N Arabic Country of Residence* loop (default: fourth 25, offset=75, limit=25).
REM Usage:
REM   run-tv-cpc-arabic-country-of-residence-fourth-25.bat
REM   run-tv-cpc-arabic-country-of-residence-fourth-25.bat --headed
...
echo Running Arabic Country of Residence offset %TV_CPC_ARABIC_COUNTRY_OF_RESIDENCE_OFFSET% limit %TV_CPC_ARABIC_COUNTRY_OF_RESIDENCE_LIMIT%...
call npm test -- tests/arabic/country-of-residence-fourth-25.spec.ts %*
exit /b %ERRORLEVEL%
