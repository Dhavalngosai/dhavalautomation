/**
 * TV CPC – Country code + Nationality (offset + limit): set both fields → Save once → comparison row.
 * Default: fourth 25 pairs (items 76-100, offset 75, limit 25).
 * 
 *
 * Run:
 *   npm test -- tests/country-code-and-nationality-fourth-25.spec.ts
 *   run-tv-cpc-fourth-25.bat
 *   run-tv-cpc-fourth-25.bat --headed
 *
 * Env:
 *   TV_CPC_URL (optional if DEFAULT_URL still valid)
 *   TV_CPC_COUNTRY_CODE_LIMIT / TV_CPC_NATIONALITY_LIMIT / TV_CPC_FIELD_LIMIT (default 25)
 *   TV_CPC_COUNTRY_CODE_OFFSET / TV_CPC_NATIONALITY_OFFSET / TV_CPC_FIELD_OFFSET (default 75)
 */
...
const countryCodeRange = getFieldRange(
  'TV_CPC_COUNTRY_CODE_LIMIT',
  'TV_CPC_COUNTRY_CODE_OFFSET',
  'TV_CPC_FIELD_LIMIT',
  'TV_CPC_FIELD_OFFSET',
  FOURTH_TWENTY_FIVE_RANGE
);
const nationalityRange = getFieldRange(
  'TV_CPC_NATIONALITY_LIMIT',
  'TV_CPC_NATIONALITY_OFFSET',
  'TV_CPC_FIELD_LIMIT',
  'TV_CPC_FIELD_OFFSET',
  FOURTH_TWENTY_FIVE_RANGE
);
...
test.describe('TV CPC – Country code + Nationality (paired save)', () => {
