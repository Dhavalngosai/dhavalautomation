/**
 * TV CPC Arabic QA – Country of Residence* values (offset + limit): select each → Save → comparison table.
...
const { limit, offset } = getFieldRange(
  'TV_CPC_ARABIC_COUNTRY_OF_RESIDENCE_LIMIT',
  'TV_CPC_ARABIC_COUNTRY_OF_RESIDENCE_OFFSET',
...
test.describe('TV CPC Arabic – Country of Residence* (offset + limit)', () => {
