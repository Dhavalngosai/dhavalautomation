/**
 * LL CPC Arabic QA – Country of Residence* values (offset + limit): select each → Save → comparison table.
...
const { limit, offset } = getFieldRange(
  'LL_CPC_ARABIC_COUNTRY_OF_RESIDENCE_LIMIT',
  'LL_CPC_ARABIC_COUNTRY_OF_RESIDENCE_OFFSET',
...
test.describe('LL CPC Arabic – Country of Residence* (offset + limit)', () => {
