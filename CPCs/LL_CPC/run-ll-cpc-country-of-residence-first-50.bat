...
REM Run offset+N Country of Residence* loop for LL CPC (default: first 50, offset=0, limit=50).
REM Usage:
REM   run-ll-cpc-country-of-residence-first-50.bat
REM   run-ll-cpc-country-of-residence-first-50.bat --headed
...
echo Running Country of Residence offset %LL_CPC_COUNTRY_OF_RESIDENCE_OFFSET% limit %LL_CPC_COUNTRY_OF_RESIDENCE_LIMIT%...
call npm test -- tests/country-of-residence-first-50.spec.ts %*
exit /b %ERRORLEVEL%
