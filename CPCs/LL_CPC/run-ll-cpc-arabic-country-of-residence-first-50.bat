...
REM Run offset+N Arabic Country of Residence* loop (default: first 50, offset=0, limit=50).
REM Usage:
REM   run-ll-cpc-arabic-country-of-residence-first-50.bat
REM   run-ll-cpc-arabic-country-of-residence-first-50.bat --headed
...
echo Running Arabic Country of Residence offset %LL_CPC_ARABIC_COUNTRY_OF_RESIDENCE_OFFSET% limit %LL_CPC_ARABIC_COUNTRY_OF_RESIDENCE_LIMIT%...
call npm test -- tests/arabic/country-of-residence-first-50.spec.ts %*
exit /b %ERRORLEVEL%
