...
REM Run offset+N Country of Residence* loop for IBAA CPC (default: fifth 25, offset=100, limit=25).
REM Usage:
REM   run-ibaa-cpc-country-of-residence-fifth-25.bat
REM   run-ibaa-cpc-country-of-residence-fifth-25.bat --headed
...
echo Running Country of Residence offset %IBAA_CPC_COUNTRY_OF_RESIDENCE_OFFSET% limit %IBAA_CPC_COUNTRY_OF_RESIDENCE_LIMIT%...
call npm test -- tests/country-of-residence-fifth-25.spec.ts %*
exit /b %ERRORLEVEL%
