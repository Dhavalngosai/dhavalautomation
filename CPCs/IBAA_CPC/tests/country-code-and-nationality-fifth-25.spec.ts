/**
 * IBAA CPC – Country code + Nationality (offset + limit): set both fields → Save once → comparison row.
 * Default: fifth 25 pairs (items 101-125, offset 100, limit 25).
 * 
 *
 * Run:
 *   npm test -- tests/country-code-and-nationality-fifth-25.spec.ts
 *   run-ibaa-cpc-fifth-25.bat
 *   run-ibaa-cpc-fifth-25.bat --headed
 *
 * Env:
 *   IBAA_CPC_URL (optional if DEFAULT_URL still valid)
 *   IBAA_CPC_COUNTRY_CODE_LIMIT / IBAA_CPC_NATIONALITY_LIMIT / IBAA_CPC_FIELD_LIMIT (default 25)
 *   IBAA_CPC_COUNTRY_CODE_OFFSET / IBAA_CPC_NATIONALITY_OFFSET / IBAA_CPC_FIELD_OFFSET (default 75)
 */
...
const countryCodeRange = getFieldRange(
  'IBAA_CPC_COUNTRY_CODE_LIMIT',
  'IBAA_CPC_COUNTRY_CODE_OFFSET',
  'IBAA_CPC_FIELD_LIMIT',
  'IBAA_CPC_FIELD_OFFSET',
  FIFTH_TWENTY_FIVE_RANGE
);
const nationalityRange = getFieldRange(
  'IBAA_CPC_NATIONALITY_LIMIT',
  'IBAA_CPC_NATIONALITY_OFFSET',
  'IBAA_CPC_FIELD_LIMIT',
  'IBAA_CPC_FIELD_OFFSET',
  FIFTH_TWENTY_FIVE_RANGE
);
...
test.describe('IBAA CPC – Country code + Nationality (paired save)', () => {
