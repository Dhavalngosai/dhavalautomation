/**
 * IBAA CPC Arabic QA – Country code + Nationality (offset + limit): set both fields → Save once → comparison row.
...
const countryCodeRange = getFieldRange(
  'IBAA_CPC_ARABIC_COUNTRY_CODE_LIMIT',
  'IBAA_CPC_ARABIC_COUNTRY_CODE_OFFSET',
  'IBAA_CPC_ARABIC_FIELD_LIMIT',
  'IBAA_CPC_ARABIC_FIELD_OFFSET',
  FIFTH_TWENTY_FIVE_RANGE
);
const nationalityRange = getFieldRange(
  'IBAA_CPC_ARABIC_NATIONALITY_LIMIT',
  'IBAA_CPC_ARABIC_NATIONALITY_OFFSET',
  'IBAA_CPC_ARABIC_FIELD_LIMIT',
  'IBAA_CPC_ARABIC_FIELD_OFFSET',
  FIFTH_TWENTY_FIVE_RANGE
);
...
test.describe('IBAA CPC Arabic – Country code + Nationality (paired save)', () => {
