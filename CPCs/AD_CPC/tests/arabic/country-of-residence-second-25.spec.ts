/**
 * AD CPC Arabic QA – Country of Residence* values (offset + limit): select each → Save → comparison table.
...
const { limit, offset } = getFieldRange(
  'AD_CPC_ARABIC_COUNTRY_OF_RESIDENCE_LIMIT',
  'AD_CPC_ARABIC_COUNTRY_OF_RESIDENCE_OFFSET',
...
test.describe('AD CPC Arabic – Country of Residence* (offset + limit)', () => {
