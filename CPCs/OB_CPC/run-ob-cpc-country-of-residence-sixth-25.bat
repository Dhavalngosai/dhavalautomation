...
REM Run offset+N Country of Residence* loop for OB CPC (default: sixth 25, offset=125, limit=25).
REM Usage:
REM   run-ob-cpc-country-of-residence-sixth-25.bat
REM   run-ob-cpc-country-of-residence-sixth-25.bat --headed
...
echo Running Country of Residence offset %OB_CPC_COUNTRY_OF_RESIDENCE_OFFSET% limit %OB_CPC_COUNTRY_OF_RESIDENCE_LIMIT%...
call npm test -- tests/country-of-residence-sixth-25.spec.ts %*
exit /b %ERRORLEVEL%
