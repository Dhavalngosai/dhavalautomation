/**
 * OB CPC Arabic QA – Country of Residence* values (offset + limit): select each → Save → comparison table.
...
const { limit, offset } = getFieldRange(
  'OB_CPC_ARABIC_COUNTRY_OF_RESIDENCE_LIMIT',
  'OB_CPC_ARABIC_COUNTRY_OF_RESIDENCE_OFFSET',
...
test.describe('OB CPC Arabic – Country of Residence* (offset + limit)', () => {
