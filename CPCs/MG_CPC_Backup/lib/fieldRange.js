...
/**
 * @param {string} fieldLimitKey - e.g. MG_CPC_COUNTRY_CODE_LIMIT
 * @param {string} fieldOffsetKey - e.g. MG_CPC_COUNTRY_CODE_OFFSET
 * @param {string} globalLimitKey - e.g. MG_CPC_FIELD_LIMIT
 * @param {string} globalOffsetKey - e.g. MG_CPC_FIELD_OFFSET
