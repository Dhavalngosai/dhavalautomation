...
REM Verify all Nationality values on Roxy Live CPC (UAE residents only).
REM Usage:
REM   run-roxy-nationality.bat
REM   run-roxy-nationality.bat --headed
...
echo Running Roxy Live CPC Nationality verification...
call npm run test:nationality -- %*
exit /b %ERRORLEVEL%
