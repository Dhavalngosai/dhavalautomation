/**
 * Roxy Live CPC – Country Code + Nationality (paired save): set both fields → Save once → comparison row.
 ...
 * Env:
 *   ROXY_CPC_URL
 *   ROXY_CPC_COUNTRY_CODE_LIMIT / ROXY_CPC_NATIONALITY_LIMIT / ROXY_CPC_FIELD_LIMIT (optional)
 *   ROXY_CPC_COUNTRY_CODE_OFFSET / ROXY_CPC_NATIONALITY_OFFSET / ROXY_CPC_FIELD_OFFSET (optional)
 */
...
test.describe('Roxy Live CPC – Country Code + Nationality (paired save)', () => {
