...
REM Verify all Country Code + Nationality values together on Roxy Live CPC (paired save).
REM Usage:
REM   run-roxy-country-code-and-nationality.bat
REM   run-roxy-country-code-and-nationality.bat --headed
...
echo Running Roxy Live CPC Country Code + Nationality verification (all values)...
