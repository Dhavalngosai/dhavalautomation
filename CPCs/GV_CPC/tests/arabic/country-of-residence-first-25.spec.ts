/**
 * GV CPC Arabic QA – Country of Residence* values (offset + limit): select each → Save → comparison table.
...
const { limit, offset } = getFieldRange(
  'GV_CPC_ARABIC_COUNTRY_OF_RESIDENCE_LIMIT',
  'GV_CPC_ARABIC_COUNTRY_OF_RESIDENCE_OFFSET',
...
test.describe('GV CPC Arabic – Country of Residence* (offset + limit)', () => {
