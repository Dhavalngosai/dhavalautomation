/**
 * TGP Live CPC – Country of Residence: select each value → Save → comparison table.
 *
 * Run:
 *   npm test -- tests/country-of-residence.spec.js
 *   run-tgp-country-of-residence.bat
 *
 * Env:
 *   TGP_CPC_URL
 *   TGP_CPC_COUNTRY_OF_RESIDENCE_LIMIT / TGP_CPC_FIELD_LIMIT (optional batch size)
 *   TGP_CPC_COUNTRY_OF_RESIDENCE_OFFSET / TGP_CPC_FIELD_OFFSET (optional batch start)
 */
...
const { limit, offset } = getFieldRange(
  'TGP_CPC_COUNTRY_OF_RESIDENCE_LIMIT',
  'TGP_CPC_COUNTRY_OF_RESIDENCE_OFFSET',
  'TGP_CPC_FIELD_LIMIT',
  'TGP_CPC_FIELD_OFFSET'
);

test.describe('TGP Live CPC – Country of Residence', () => {
