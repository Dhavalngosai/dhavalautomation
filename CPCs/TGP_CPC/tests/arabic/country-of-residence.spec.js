/**
 * TGP Live CPC Arabic – Country of Residence: select each value → Save → comparison table.
 *
 * Run:
 ...
 * Env:
 *   TGP_CPC_ARABIC_URL
 *   TGP_CPC_ARABIC_COUNTRY_OF_RESIDENCE_LIMIT / TGP_CPC_ARABIC_FIELD_LIMIT (optional batch size)
 *   TGP_CPC_ARABIC_COUNTRY_OF_RESIDENCE_OFFSET / TGP_CPC_ARABIC_FIELD_OFFSET (optional batch start)
 */
...
const { limit, offset } = getFieldRange(
  'TGP_CPC_ARABIC_COUNTRY_OF_RESIDENCE_LIMIT',
  'TGP_CPC_ARABIC_COUNTRY_OF_RESIDENCE_OFFSET',
  'TGP_CPC_ARABIC_FIELD_LIMIT',
  'TGP_CPC_ARABIC_FIELD_OFFSET'
);

test.describe('TGP Live CPC Arabic – Country of Residence', () => {
