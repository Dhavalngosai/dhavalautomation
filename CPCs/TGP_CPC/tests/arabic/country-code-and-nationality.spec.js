/**
 * TGP Live CPC Arabic – Country Code + Nationality (paired save): set both fields → Save once → comparison row.
 ...
 * Env:
 *   TGP_CPC_ARABIC_URL
 *   TGP_CPC_ARABIC_COUNTRY_CODE_LIMIT / TGP_CPC_ARABIC_NATIONALITY_LIMIT / TGP_CPC_ARABIC_FIELD_LIMIT (optional)
 *   TGP_CPC_ARABIC_COUNTRY_CODE_OFFSET / TGP_CPC_ARABIC_NATIONALITY_OFFSET / TGP_CPC_ARABIC_FIELD_OFFSET (optional)
 */
...
const countryCodeRange = getFieldRange(
  'TGP_CPC_ARABIC_COUNTRY_CODE_LIMIT',
  'TGP_CPC_ARABIC_COUNTRY_CODE_OFFSET',
  'TGP_CPC_ARABIC_FIELD_LIMIT',
  'TGP_CPC_ARABIC_FIELD_OFFSET'
);
const nationalityRange = getFieldRange(
  'TGP_CPC_ARABIC_NATIONALITY_LIMIT',
  'TGP_CPC_ARABIC_NATIONALITY_OFFSET',
  'TGP_CPC_ARABIC_FIELD_LIMIT',
  'TGP_CPC_ARABIC_FIELD_OFFSET'
);

test.describe('TGP Live CPC Arabic – Country Code + Nationality (paired save)', () => {
  test('set country code and nationality together, save once per iteration (all values)', async ({ page }, testInfo) => {
    test.setTimeout(0);
    test.skip(!cpcUrl, 'Set TGP_CPC_ARABIC_URL in .env to the full Arabic Cloud Page link (including qs=).');
