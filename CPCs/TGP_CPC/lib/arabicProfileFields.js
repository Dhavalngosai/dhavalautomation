/**
 * TGP Live CPC Arabic – My Profile field helpers (Arabic labels; Select2-backed Country of Residence).
 */
const {
  getCountryCodes,
  setCountryCode,
...
/**
 * Select Country of Residence via Select2 UI (preferred on Arabic TGP CPC).
 * @param {import('@playwright/test').Page} page
 * @param {string} label
 */
