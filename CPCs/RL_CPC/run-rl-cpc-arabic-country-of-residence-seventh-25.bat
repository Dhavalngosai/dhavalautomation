...
REM Run offset+N Arabic Country of Residence* loop (default: seventh 25, offset=150, limit=25).
REM Usage:
REM   run-rl-cpc-arabic-country-of-residence-seventh-25.bat
REM   run-rl-cpc-arabic-country-of-residence-seventh-25.bat --headed
...
echo Running Arabic Country of Residence offset %RL_CPC_ARABIC_COUNTRY_OF_RESIDENCE_OFFSET% limit %RL_CPC_ARABIC_COUNTRY_OF_RESIDENCE_LIMIT%...
call npm test -- tests/arabic/country-of-residence-seventh-25.spec.ts %*
exit /b %ERRORLEVEL%
