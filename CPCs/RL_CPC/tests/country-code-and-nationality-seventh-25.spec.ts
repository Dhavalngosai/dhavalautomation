/**
 * RL CPC – Country code + Nationality (offset + limit): set both fields → Save once → comparison row.
 * Default: seventh 25 pairs (items 151-175, offset 150, limit 25).
 * 
 *
 * Run:
 *   npm test -- tests/country-code-and-nationality-seventh-25.spec.ts
 *   run-rl-cpc-seventh-25.bat
 *   run-rl-cpc-seventh-25.bat --headed
 *
 * Env:
 *   RL_CPC_URL (optional if DEFAULT_URL still valid)
 *   RL_CPC_COUNTRY_CODE_LIMIT / RL_CPC_NATIONALITY_LIMIT / RL_CPC_FIELD_LIMIT (default 25)
 *   RL_CPC_COUNTRY_CODE_OFFSET / RL_CPC_NATIONALITY_OFFSET / RL_CPC_FIELD_OFFSET (default 75)
 */
...
const countryCodeRange = getFieldRange(
  'RL_CPC_COUNTRY_CODE_LIMIT',
  'RL_CPC_COUNTRY_CODE_OFFSET',
  'RL_CPC_FIELD_LIMIT',
  'RL_CPC_FIELD_OFFSET',
  SEVENTH_TWENTY_FIVE_RANGE
);
const nationalityRange = getFieldRange(
  'RL_CPC_NATIONALITY_LIMIT',
  'RL_CPC_NATIONALITY_OFFSET',
  'RL_CPC_FIELD_LIMIT',
  'RL_CPC_FIELD_OFFSET',
  SEVENTH_TWENTY_FIVE_RANGE
);
...
test.describe('RL CPC – Country code + Nationality (paired save)', () => {
