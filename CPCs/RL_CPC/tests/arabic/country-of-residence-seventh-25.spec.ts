/**
 * RL CPC Arabic QA – Country of Residence* values (offset + limit): select each → Save → comparison table.
...
const { limit, offset } = getFieldRange(
  'RL_CPC_ARABIC_COUNTRY_OF_RESIDENCE_LIMIT',
  'RL_CPC_ARABIC_COUNTRY_OF_RESIDENCE_OFFSET',
...
test.describe('RL CPC Arabic – Country of Residence* (offset + limit)', () => {
