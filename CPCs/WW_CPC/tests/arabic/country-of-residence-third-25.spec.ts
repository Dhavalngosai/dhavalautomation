/**
 * WW CPC Arabic QA – Country of Residence* values (offset + limit): select each → Save → comparison table.
...
const { limit, offset } = getFieldRange(
  'WW_CPC_ARABIC_COUNTRY_OF_RESIDENCE_LIMIT',
  'WW_CPC_ARABIC_COUNTRY_OF_RESIDENCE_OFFSET',
...
test.describe('WW CPC Arabic – Country of Residence* (offset + limit)', () => {
