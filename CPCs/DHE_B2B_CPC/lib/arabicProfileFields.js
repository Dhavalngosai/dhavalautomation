/**
 * DHE B2B CPC Arabic QA – My Profile field helpers (Arabic labels; Select2-backed Country of Residence).
 */
const {
  clickProfileSave,
  getCountryCodes,
...
/**
 * Select Country of Residence via Select2 UI (preferred on Arabic DHE B2B CPC).
 * @param {import('@playwright/test').Page} page
 * @param {string} label
 */
...
async function reloadArabicMyProfile(page, cpcUrl, options = {}) {
  const { requireNationality = false } = options;
