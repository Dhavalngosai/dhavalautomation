/**
 * Helpers for DHE B2B CPC My Profile fields:
 * Country code (#country-code), Country of Residence (#profileCountry).
 * Note: DHE B2B has no Nationality field (unlike consumer CPCs).
