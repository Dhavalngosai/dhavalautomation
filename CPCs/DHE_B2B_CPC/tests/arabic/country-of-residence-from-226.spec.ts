/**
 * DHE B2B CPC Arabic QA – Country of Residence* values (offset + limit): select each → Save → comparison table.
...
const { limit, offset } = getFieldRange(
  'DHE_B2B_CPC_ARABIC_COUNTRY_OF_RESIDENCE_LIMIT',
  'DHE_B2B_CPC_ARABIC_COUNTRY_OF_RESIDENCE_OFFSET',
...
test.describe('DHE B2B CPC Arabic – Country of Residence* (offset + limit)', () => {
