...
REM Run offset+N Arabic Country of Residence* loop (default: ninth 25, offset=200, limit=25).
REM Usage:
REM   run-rm-cpc-arabic-country-of-residence-ninth-25.bat
REM   run-rm-cpc-arabic-country-of-residence-ninth-25.bat --headed
...
echo Running Arabic Country of Residence offset %RM_CPC_ARABIC_COUNTRY_OF_RESIDENCE_OFFSET% limit %RM_CPC_ARABIC_COUNTRY_OF_RESIDENCE_LIMIT%...
call npm test -- tests/arabic/country-of-residence-ninth-25.spec.ts %*
exit /b %ERRORLEVEL%
