/**
 * RM CPC Arabic QA – My Profile field helpers (Arabic labels; Select2-backed Country of Residence).
 */
const {
  clickProfileSave,
  getCountryCodes,
...
/**
 * Select Country of Residence via Select2 UI (preferred on Arabic RM CPC).
 * @param {import('@playwright/test').Page} page
 * @param {string} label
 */
