/**
 * RM CPC Arabic QA – Country of Residence* values (offset + limit): select each → Save → comparison table.
...
const { limit, offset } = getFieldRange(
  'RM_CPC_ARABIC_COUNTRY_OF_RESIDENCE_LIMIT',
  'RM_CPC_ARABIC_COUNTRY_OF_RESIDENCE_OFFSET',
...
test.describe('RM CPC Arabic – Country of Residence* (offset + limit)', () => {
