...
REM Run offset+N Country of Residence* loop for RM CPC (default: ninth 25, offset=200, limit=25).
REM Usage:
REM   run-rm-cpc-country-of-residence-ninth-25.bat
REM   run-rm-cpc-country-of-residence-ninth-25.bat --headed
...
echo Running Country of Residence offset %RM_CPC_COUNTRY_OF_RESIDENCE_OFFSET% limit %RM_CPC_COUNTRY_OF_RESIDENCE_LIMIT%...
call npm test -- tests/country-of-residence-ninth-25.spec.ts %*
exit /b %ERRORLEVEL%
