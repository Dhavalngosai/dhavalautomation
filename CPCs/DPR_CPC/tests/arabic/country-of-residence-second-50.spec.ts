/**
 * DPR CPC Arabic QA – Country of Residence* values (offset + limit): select each → Save → comparison table.
...
const { limit, offset } = getFieldRange(
  'DPR_CPC_ARABIC_COUNTRY_OF_RESIDENCE_LIMIT',
  'DPR_CPC_ARABIC_COUNTRY_OF_RESIDENCE_OFFSET',
  'DPR_CPC_ARABIC_FIELD_LIMIT',
  'DPR_CPC_ARABIC_FIELD_OFFSET'
);
const rangeLabel = formatRangeLabel(offset, limit);

test.describe('DPR CPC Arabic – Country of Residence* (offset + limit)', () => {
