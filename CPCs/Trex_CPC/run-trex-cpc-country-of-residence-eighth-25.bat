...
REM Run offset+N Country of Residence* loop for Trex CPC (default: eighth 25, offset=175, limit=25).
REM Usage:
REM   run-trex-cpc-country-of-residence-eighth-25.bat
REM   run-trex-cpc-country-of-residence-eighth-25.bat --headed
...
echo Running Country of Residence offset %TREX_CPC_COUNTRY_OF_RESIDENCE_OFFSET% limit %TREX_CPC_COUNTRY_OF_RESIDENCE_LIMIT%...
call npm test -- tests/country-of-residence-eighth-25.spec.ts %*
exit /b %ERRORLEVEL%
