...
/**
 * @param {string} fieldLimitKey - e.g. TREX_CPC_COUNTRY_CODE_LIMIT
 * @param {string} fieldOffsetKey - e.g. TREX_CPC_COUNTRY_CODE_OFFSET
 * @param {string} globalLimitKey - e.g. TREX_CPC_FIELD_LIMIT
 * @param {string} globalOffsetKey - e.g. TREX_CPC_FIELD_OFFSET
