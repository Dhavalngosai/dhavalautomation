/**
 * Trex CPC Arabic QA – Country of Residence* values (offset + limit): select each → Save → comparison table.
...
const { limit, offset } = getFieldRange(
  'TREX_CPC_ARABIC_COUNTRY_OF_RESIDENCE_LIMIT',
  'TREX_CPC_ARABIC_COUNTRY_OF_RESIDENCE_OFFSET',
...
test.describe('Trex CPC Arabic – Country of Residence* (offset + limit)', () => {
