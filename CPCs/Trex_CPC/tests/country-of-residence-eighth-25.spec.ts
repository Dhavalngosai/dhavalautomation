/**
 * Trex CPC – Country of Residence* values (offset + limit): select each → Save → comparison table.
 * Default: eighth 25 values (items 176-200, offset 175, limit 25).
 *
 * Run:
 *   npm test -- tests/country-of-residence-eighth-25.spec.ts
 *   run-trex-cpc-country-of-residence-eighth-25.bat
 *
 * Env:
 *   TREX_CPC_URL (optional if DEFAULT_URL still valid)
 *   TREX_CPC_COUNTRY_OF_RESIDENCE_LIMIT / TREX_CPC_FIELD_LIMIT (default 25)
 *   TREX_CPC_COUNTRY_OF_RESIDENCE_OFFSET / TREX_CPC_FIELD_OFFSET (default 75)
 */
...
const { limit, offset } = getFieldRange(
  'TREX_CPC_COUNTRY_OF_RESIDENCE_LIMIT',
  'TREX_CPC_COUNTRY_OF_RESIDENCE_OFFSET',
...
test.describe('Trex CPC – Country of Residence* (offset + limit)', () => {
